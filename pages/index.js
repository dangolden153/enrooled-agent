...
export default function LandingPage() {
  return (
    <div className={`col-12 justify-content-between ${styles.landingPage}`}>
      ...
      <div className={`${styles.stats} d-flex flex-row text-center align-items-center justify-content-center`}>
        <div className="col-4">
          <h1>60,000+</h1>
      ...
      <div className={`${styles.topRated} d-flex flex-column w-100 align-items-center justify-content-center`}>
        <div className="col-12 d-flex flex-column align-items-center justify-content-center">
          <h1>Top Rated Enrolled Agents</h1>
          <span>Licensed and Verified Enrolled Agents</span>
        </div>
        <div className={`${styles.cardList} d-flex flex-column flex-lg-row w-100 align-items-center justify-content-center`}>
