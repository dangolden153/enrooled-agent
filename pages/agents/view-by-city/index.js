...
const index = () => {
    return (
        <div className={`${styles.viewBy} d-flex flex-column justify-content-center`}>
            ...
            <div className={styles.letters}>
                <h6>Search cities by letters</h6>
